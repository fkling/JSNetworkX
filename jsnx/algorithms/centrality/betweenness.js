 ...
 * @export
*/
jsnx.algorithms.centrality.betweenness.betweenness_centrality = function(G, opt_arg_dict) {
  ...
  jsnx.helper.forEach(nodes.sort(), function(s) {
    ...
    var results = [];
    if (goog.object.get(goog.asserts.assertObject(opt_arg_dict), 'weight', null) === null) {
    ...
    sigma = results[2];
    // accumulation
    if (goog.object.get(goog.asserts.assertObject(opt_arg_dict), 'endpoints', false)) {
